...
const Footer = () => {
   return (
      <footer className="text-black bg-gray-100 body-font bottom-0 left-0 w-full">
         <div className="container px-5 py-10 mx-auto flex items-center sm:flex-row flex-col">
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-black">
               <Image
                  src={"/images/profile-portfolio-svgrepo-com.svg"}
                  width={50}
                  height={50}
                  alt="Logo"
               />
               <span className="ml-3 text-xl">Hamdan</span>
            </a>
            ...
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
               <a
                  className="text-gray-400 hover:text-[#3b5998]"
               ...
               <a
                  ...
                  href="https://github.com/hamdanbhatti"
                  target="_blank"
                  rel="noopener noreferrer"
               >
                  <svg
               ...
               <a
                  className="ml-3 text-gray-400 hover:text-[#C13584]"
                  href="https://www.instagram.com/hamdanbhatti976/profilecard/?igsh=MXNuNWwxcXl2aDc1cQ=="
                  target="_blank"
                  rel="noopener noreferrer"
               >
                  <svg
               ...
               <a
                  className="ml-3 text-gray-400 hover:text-[#0077B5]"
